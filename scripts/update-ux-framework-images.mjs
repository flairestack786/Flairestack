...
const FRAMEWORK = {
  framework1: { source: 'pexels', id: 3861966 },
  framework2: { source: 'pexels', id: 196646 },
  framework3: { source: 'unsplash', id: '1547658719-da2b51169166' },
  framework4: { source: 'pexels', id: 590022 },
}
...
console.log('UI/UX Design: 4 framework images updated')
