-- =============================================================================
-- FlaireStack CMS — repair Home page seed
-- Fixes databases where 20260708160000 seed inserted 0 rows under RLS.
-- Idempotent: skips rows that already exist; does not update existing data.
-- =============================================================================
